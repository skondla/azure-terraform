...
export TF_VAR_backendPoolId="/subscriptions/23583f43-xxxx-abcd-kstr-yyyyyyyyy/resourceGroups/chkmarx-conf-compute-mvp/providers/Microsoft.Network/loadBalancers/chkmarx-lb/backendAddressPools/chkmarx-lbbepool"
