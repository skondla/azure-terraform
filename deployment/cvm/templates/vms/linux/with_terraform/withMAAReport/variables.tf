...
variable "backendPoolId" {
  type    = string
  default = "/subscriptions/45adad4f-3a50xxxxx-yyyyyy-zzzz/resourceGroups/futureai-conf-compute-mvp/providers/Microsoft.Network/loadBalancers/futureai-lb/backendAddressPools/futureai-lbbepool"
}
